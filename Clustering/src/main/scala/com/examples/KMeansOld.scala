...
object KMeansOld {
	...
	def main(argv : Array[ String ]) {
		...
		val resultCentroids = KMeansOld(dataPoints, centroids, 0.0001f)
	...
	def KMeansOld(points : Seq[ DataPoint ], centroids : Seq[ DataPoint ], delta : Float) : Seq[ DataPoint ] = {
		...
		{
			KMeansOld(points, newCentroids, delta)
		}
	}
}
